...
DATABASES = {
    'default': {
        ...
        'HOST': 'okt-capstone.cbanmzptkrzf.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'okt-capstone-blog' # please enter your s3 bucket name
